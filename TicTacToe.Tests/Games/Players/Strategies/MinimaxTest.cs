    ...
    public class MinimaxTest
    {
        ...
        public void MinimaxReturnsNegativeScoreIfOpponentCanWin()
        {
            string[] spaces = {"O", "O", "X",
                              "X", "X", "5",
                             "O", "O", "8" };
            int bestValue = Minimax.MinOrMaxScore(spaces, "O", 3, true, 3);
        ...
        public void MinimaxReturnsPositiveScoreIfWinningBoard()
        {
            string[] spaces = {"O", "O", "O",
                               "3", "4", "5",
                               "6", "7", "8"};
            int bestValue = Minimax.MinOrMaxScore(spaces, "O", 7, true, 7);
        ...
        public void MinimaxReturnsPostiveScoreIfInFavorablePosition()
        {
            string[] spaces = {"O", "1", "O",
                               "X", "X", "O",
                               "6", "7", "8" };
            int bestValue = Minimax.MinOrMaxScore(spaces, "O", 5, true, 5);
        ...
        public void MinimaxReturnZeroScoreIfBestItCanDoIsTie()
        {
            string[] spaces = {"O", "X", "O",
                               "X", "X", "5",
                               "X", "O", "8"};
            int bestValue = Minimax.MinOrMaxScore(spaces, "X", 3, false, 3);
